 ...
 */
@Repository
public interface ServizioRaggiungibilitaRepository extends JpaRepository<ServizioRaggiungibilita, Long> {

    Optional<ServizioRaggiungibilita> findByAppId(String appId);
